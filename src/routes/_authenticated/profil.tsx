...
import { ArrowRight, Coins, Flame, Images, Landmark, Layers, Settings, Sparkles, Trophy, UserRound } from "lucide-react";
...
export const Route = createFileRoute("/_authenticated/profil")({
  head: () => ({
    meta: [
      { title: "Profil — Dashboard & Fortschritt | Provenance" },
      {
        name: "description",
        content:
          "Dein Provenance-Profil: Level, Punkte, Coins, Serie, Entdeckungen, Lernfortschritt und persönliche Kunstwelt.",
      },
      { property: "og:title", content: "Profil | Provenance" },
      { property: "og:description", content: "Dashboard und Fortschritt in Provenance." },
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
      ...
      <section className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Link to="/einstellungen" className="group flex items-center gap-4 rounded-xl border border-border bg-background p-5 transition-colors hover:bg-accent">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-border"><UserRound className="h-4 w-4" /></div>
          <div><p className="font-display font-medium">Profil bearbeiten</p><p className="text-xs text-muted-foreground">Name, Bild, Passwort</p></div>
        </Link>
        <Link to="/sammlung" className="group flex items-center gap-4 rounded-xl border border-border bg-background p-5 transition-colors hover:bg-accent">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-border"><Images className="h-4 w-4" /></div>
          <div><p className="font-display font-medium">Galerie</p><p className="text-xs text-muted-foreground">Werke ansehen & ausstellen</p></div>
        </Link>
        <Link to="/auktionshaus" className="group flex items-center gap-4 rounded-xl border border-border bg-background p-5 transition-colors hover:bg-accent">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-border"><Coins className="h-4 w-4" /></div>
          <div><p className="font-display font-medium">Auktionshaus</p><p className="text-xs text-muted-foreground">Werke ersteigern</p></div>
        </Link>
        <Link to="/kunstpfad" className="group flex items-center gap-4 rounded-xl border border-border bg-background p-5 transition-colors hover:bg-accent">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-border"><Layers className="h-4 w-4" /></div>
          <div><p className="font-display font-medium">Reise</p><p className="text-xs text-muted-foreground">{pathProgress?.length ?? 0}/{artPathWithWorks.length} Stationen</p></div>
        </Link>
      </section>
      ...
      <section className="mt-16 rounded-xl border border-border bg-muted/40 p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            to="/einstellungen"
            className="inline-flex items-center gap-2 rounded-full border border-input px-6 py-2.5 text-sm transition-colors hover:bg-accent"
          >
