  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
      ...
      <section className="mt-10 grid gap-4 sm:grid-cols-2">
        <Link to="/kunstpfad" className="flex items-center gap-4 rounded-xl border border-border bg-background p-6 transition-transform hover:-translate-y-0.5"><img src={coin} alt="" width={1024} height={1024} className="h-14 w-14" /><span><span className="font-display block text-xl font-medium">Kunstpfad</span><span className="text-sm text-muted-foreground">Quiz lösen, Stationen öffnen und Coins verdienen</span></span></Link>
