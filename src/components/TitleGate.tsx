  ...
  return (
    <div className="fixed inset-0 z-[110] overflow-y-auto bg-background">
      <div className="mx-auto flex min-h-full w-full max-w-xl flex-col justify-center px-6 py-12">
        <div className="flex min-h-28 w-full items-center justify-center overflow-visible sm:min-h-36">
          <ProvenanceLogo className="mx-auto text-[clamp(4.5rem,19vw,8rem)]" />
        </div>
